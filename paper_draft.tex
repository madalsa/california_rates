...
Bill calculation for designed rate scenarios is fully vectorized: each scenario's six TOU rates are mapped to an 8,760-element rate array, and annual volumetric charges are computed as a dot product between the building's hourly load profile and the rate array. For actual SDGE tariff rates, the full bill calculator handles baseline credits, tier structures, minimum bill provisions, and CARE discounts. All calculations use RASS-calibrated load profiles and scenario-specific fixed charges.

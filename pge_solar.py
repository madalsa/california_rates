...
def stage4_solar_profiles(tech_df, bills_df):
    ...
    Returns a dict {cz: solar_per_kw_array} and a dict {cz: annual_kWh_per_kW}.
    """
    print("\n" + "=" * 80)
